<%@ Page Title="" Language="VB" MasterPageFile="~/popup.master" AutoEventWireup="false"
    CodeFile="rate_rule_maxmin_schedule_a.aspx.vb" Inherits="rate_rule_maxmin_schedule_a" %>

<asp:Content ID="C1" ContentPlaceHolderID="cphMain" Runat="Server">
    <p align="center">
        &nbsp;</p>
    <p align="center">
        <font size="5" color="#384F5B">Rate Max. / Min. Schedule</font></p>
    <p align="center">
            ...
            <tr>
                ...
                <td align="left">
                    <asp:DropDownList ID="ddlScheduleTypes" runat="server" Width="100">
                        <asp:ListItem Selected="True" Text="Max./Min." Value="4"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
