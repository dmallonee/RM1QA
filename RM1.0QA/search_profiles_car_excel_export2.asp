...
'-----------------------------------------------------------------------
	...
	adoCmd.CommandText = "car_shop_profile_select_export_with_schedule"
...
'	adoCmd.Parameters.Append adoCmd.CreateParameter("@profile_id",          3, 1, 0)
	...
	'--- open the template simpletemplate.xls.
		objSAXLTmplt.Open Server.MapPath(Application("vroot") & "templates/profile_extract_template_with_schedules.xls")
