...
'-----------------------------------------------------------------------
	...
	adoCmd.CommandText = "support_export_profiles_for_rate_calc" ' "car_shop_profile_select_export"
	...
	adoCmd.Parameters("@org_id").Value = Null
	...
	'--- open the template simpletemplate.xls.
		objSAXLTmplt.Open Server.MapPath(Application("vroot") & "templates/rate_calc_extract_template.xls")
