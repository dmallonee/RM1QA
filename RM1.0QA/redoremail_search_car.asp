...
<% Response.Expires = -1
   ...
   Server.ScriptTimeout = 0
	...
	adoCmd.CommandText = "car_shop_request_search_redo"
	adoCmd.CommandType = 4

	adoCmd.Parameters.Append adoCmd.CreateParameter("@shop_request_id"   , adInteger, 1, 0 )
	adoCmd.Parameters.Append adoCmd.CreateParameter("@included_maxed_out", adBoolean, 1, 0, True )
	adoCmd.Parameters.Append adoCmd.CreateParameter("@reset_sent_dttm"   , adBoolean, 1, 0, True )
