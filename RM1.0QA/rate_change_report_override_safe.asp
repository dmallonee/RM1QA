...
<p><font size="-1">
 <table width="1700" border="0" cellpadding="2" background="images/alt_color.gif" style="border-collapse: collapse" bordercolor="#111111" id="table1">
    <tr valign="bottom">
      <td >&nbsp;Advanced Rate Rule Alert Report - Updateable</td>
    </tr>
  </table>
  ...
  <table border="1" bordercolor="#FFFFFF" id="rate_changes" width="1700" cellspacing="0" cellpadding="0" >
    <tr>
      ...
      <th class="profile_header" width="50"><font size="2">LOR</th>
      <th class="profile_header" width="75"><font size="2">Comp. Set Max</th>
      <th class="profile_header" width="75"><font size="2">Comp. Set Min</th>
      <th class="profile_header" width="50"><font size="2">Min Rate Vendor</th>
      <th class="profile_header" width="75"><font size="2">Util. level</th>      
...
<%	
	...
	If err.number <> 0 Then
	   pad="&nbsp;&nbsp;&nbsp;&nbsp;"
	   response.write "<b>Error occured creating rate grid<br>"
	   response.write parm_msg & "</b><br>"
	   response.write pad & "Error Number= #<b>" & err.number & "</b><br>"
	   response.write pad & "Error Desc.= <b>" & err.description & "</b><br>"
	   response.write pad & "Help Context= <b>" & err.HelpContext & "</b><br>"
