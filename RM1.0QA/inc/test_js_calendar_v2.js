...
function openCal(v_input,s_from,s_to,s_cal,s_parent,s_mode,s_caldir){
	...
	while (o_parent.tagName != "BODY") {
		...
		alert("o_parent.name = " + o_parent.name + "\n" + "o_parent.tagName = " + o_parent.tagName + "\n" + 
		      "parent_offset = " + parent_offset + "\n" + "parent_offset_left = " + parent_offset_left + "\n" + 
		      "o_parent.clientHeight = " + o_parent.clientHeight + "\n" + "o_parent.offsetHeight = " + o_parent.offsetHeight + "\n" + 
		      "o_parent.offsetLeft = " + o_parent.offsetLeft + "\n" + "o_parent.offsetTop = " + o_parent.offsetTop );
	...
	alert("body.name = " + document.body.name + "\n" + "o_parent.tagName = " + document.body.tagName + "\n" + 
	      "o_parent.offsetTop = " + o_parent.offsetTop + "\n" + "o_parent.offsetHeight = " + o_parent.offsetHeight );
	
	
	//alert("o_inputright.tagName = " + o_inputright.tagName + "\n" +
	//      "o_inputright.offsetLeft = " + o_inputright.offsetLeft + "\n" +
	//      "o_inputright.offsetWidth= " + o_inputright.offsetWidth + "\n" +
	//      "parent_offset_left = " + o_parent.offsetLeft); 
	i_calx = (parseInt(document.body.clientWidth) - parseInt(o_parent.clientWidth)) / 2;
	//alert("document.body.clientWidth = " + document.body.clientWidth);
	//alert("o_parent.clientWidth = " + o_parent.clientWidth);
	//alert("i_calx = " + i_calx);
...
//	i_caly = parseInt(o_parent.offsetTop) - (parseInt(o_cal.offsetHeight)/2);

	alert("i_caly = " + i_caly);
//	i_caly = i_caly - 515;
	//alert("i_caly (top) = " + i_caly + "\n i_calx (left) = " + i_calx);

	//alert("The o_inputright element is at (" + o_inputright.offsetLeft + 
    //      "," + o_inputright.offsetTop + ")\n" + "The offset parent is " + o_parent.tagName );
	if (i_caly < 0){
	i_caly = (i_caly * -1) + 30;
	}
