...
%>
	<tr class="">
		...
		<td>
			...
			<input name="input_min_<%=iRowLoop %>" id="input_min_<%=iRowLoop %>" class="<%=strCellClass %>" type="text" value="<%=strCellValue %>" onkeypress="return checkForInt(event)" onblur="return validateRange(this.value)" >
		</td>
