...
<table border="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%" cellspacing="0" height="4">
  ...
  <table border="1" style="border-collapse: collapse" bordercolor="#FFFFFF" width="1310" id="profiles">
    <tr>
      ...
      <td class="profile_header" width="288" height="45"><font size="2">Situation 
      (if you situation is listed as a number, please contact 
      support@rate-highway.com)</font></td>
      <td class="profile_header" width="102" height="45"><font size="2">Location(s)</font></td>
      <td class="profile_header" width="100" height="45"><font size="2">
      Recipient or Response</font></td>
      <td class="profile_header" width="342" height="45"><font size="2">Search Type / Profile</font></td>
    </tr>
  ...
  <tr>
    ...
    <td class="<%=strClass %>" height="20" width="288">
  ...
  | <a target="_blank" href="rule_upload.asp">Upload rules</a></font></form>
...
<form name="create_alert" method="POST" action="" OnSubmit="return CreateAlert()"  >
  ...
  <table border="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="1210" id="new_alert" background="images/alt_color.gif" height="561">
    ...
    <tr>
      ...
      <td width="210" height="25"><font face="Verdana" size="2">1. Rate Change Alert No.:</font></td>
      ...
      <input type="checkbox" name="copy" id="copy" value="true"><label for="copy"><font face="Verdana" size="2">Save as a copy (leaves the original unchanged)</font></label></td>
    ...
    <tr>
      ...
      <td width="217" height="25">
      &nbsp;</td>
      <td width="210" height="25"><font face="Verdana" size="2">3. Rule Begin Date:</font></td>
      <td width="510" height="25" colspan="8">
    ...
    <tr>
      ...
      <% End If %>
      <label for="rolling_dates"><font size="2">Rolling begin & end</font></label></td>
      <td width="510" height="25" colspan="8">
    ...
    <tr>
      ...
      <td width="217" height="25">
      &nbsp;</td>
      <td width="210" height="25"><font face="Verdana" size="2">4. Rule End Date:</font></td>
      <td width="510" height="25" colspan="8">
...
-->
    ...
    <tr>
      <td width="8" height="19">&nbsp;</td>
      <td width="217" height="19">&nbsp;</td>
      <td width="210" height="19"><font face="Verdana" size="2">&nbsp;&nbsp;&nbsp;&nbsp; Comparison Car&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp; Type(s):</font></td>
    ...
    <tr>
      ...
      <td width="210" height="19">&nbsp;</td>
      <td width="510" height="19" colspan="8">
      <font face="Verdana" size="2">(use &quot;n/a&quot; to 
...
&nbsp;both items to have the system match car types)</font></td>
    ...
    <tr>
      <td width="8" height="19">&nbsp;</td>
      <td width="217" height="19">&nbsp;</td>
      <td width="210" height="19"><font face="Verdana" size="2">12. Rate Source::</td>
      <td width="510" height="19" colspan="8">
...
<!--
      <% If blnResponseDollar Then %>
	      <input type="radio" value="1" name="is_response_dollar" id="is_response_dollar1" style="font-family:Verdana; font-size:10pt" checked><font face="Verdana" size="2">Dollar amount<br>
	  ...
	  <% Else					   %>
	      <input type="radio" value="1" name="is_response_dollar" id="is_response_dollar1" style="font-family:Verdana; font-size:10pt" ><font face="Verdana" size="2">Whole Dollar<br>
...
-->
    ...
    <tr>
      ...
      <td width="210" height="19">&nbsp;</td>
      <td width="510" height="19" colspan="8">
		<font face="Verdana" size="2" color="#080000">&nbsp;<a href="javascript:toggleLayer('ExtraDay');" title="Add extra day and hour rates to this rule">Show Extra Rate 
		detail</a></font></td>
      <td width="262" height="19">&nbsp;</td>
    </tr>
</table>
...
-->      
    ...
    <tr>
      ...
      <font face="Verdana" size="2">
		...
		<a title="Click to edit or create a rule schedule" href="rate_rule_maxmin_schedule_a.asp" onclick="window.open('rate_rule_maxmin_schedule_a.asp','manage_schedule','toolbar=no,status=no,scrollbars=yes,resizable=no,width=820,height=600'); return false;">Manage schedules</a></font></td>
      <td width="262" height="22">&nbsp;</td>
    </tr>
    <tr>
      <td width="8" height="22">&nbsp;</td>
    ...
    <tr>
      ...
      <td width="210" style="height: 7px"><font face="Verdana" size="2">&nbsp;&nbsp;&nbsp;&nbsp; Maximum:</td>
    ...
    <tr>
      ...
      <td width="210" style="height: 24px"><font face="Verdana" size="2">&nbsp;&nbsp;&nbsp;&nbsp; Minimum:</td>
    ...
    <tr>
      ...
      <font face="Verdana" size="2">
		...
		<a title="Click to edit or create a rule schedule" href="rate_rule_schedule_a.asp" onclick="window.open('rate_rule_schedule_a.asp','manage_schedule','toolbar=no,status=no,scrollbars=yes,resizable=no,width=820,height=600'); return false;">Manage schedules</a></font></td>
      <td width="262" height="22">&nbsp;</td>
    </tr>
    <tr>
      <td width="8" height="22">&nbsp;</td>
