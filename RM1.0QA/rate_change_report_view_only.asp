...
<p><font size="-1">
 ...
 <%
    ...
    <input type="checkbox" value="<%=adoRS.Fields("car_rate_rule_change_id").Value %>" name="car_rate_rule_change_id"  disabled></td>
...
%>    
  ...
  <p>&nbsp;
  <!--
  | <a href="javascript:checkAll(document.rate_change.car_rate_rule_change_id)">Select All</a> 
  | <a  href="javascript:uncheckAll(document.rate_change.car_rate_rule_change_id)">Unselect All</a> |
  -->
  </p>
  <p><input type="submit" value="Perform Update" name="update"  disabled ></font></p>
