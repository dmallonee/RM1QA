...
<%
	...
	'adoCmd2.CommandText = "car_rate_rule_export"
	...
	'Set adoRS2 = adoCmd2.Execute
  	...
  	adoRS2.Open  "EXEC car_rate_rule_export " & strUserId, adoConn
...
'	Obj.Footer = "Hello folks" & vbCrLf & "Hello again "
	Obj.ExportTypeStr = "csv"
	Obj.ShowExport adoRS2, -1, "Rate-Monitor rule upload.csv"
