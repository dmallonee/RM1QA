...
Partial Class tp_maxmin_schedule_b
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            linkBack.NavigateUrl = "~/tp_maxmin_schedule_a.aspx?user_id=" & Request.QueryString("user_id")
        End If
    End Sub
    ...
    Private Sub LoadTabStrip(ByVal index As Integer)
        ...
        Dim da As New Schedules3TableAdapters.user_cityTableAdapter
        Dim dt As New Schedules3.user_cityDataTable
        'arrLocations = New ArrayList
        da.Fill(dt, Request.QueryString("user_id"))

        'Dim r As Schedules3.user_cityRow
        ...
        Dim r As Schedules3.user_cityRow
        'This is necessary in order to deal with null resultset
        ...
        If tabcount > 0 Then TabStrip1.SelectedTab = TabStrip1.Tabs(0).Tabs(0)
    ...
    Private Sub BindGrid(ByVal SelLocation As String, ByVal SelMonth As Integer)
        Dim da As New Schedules3TableAdapters.car_rate_rule_schedule_detail_3TableAdapter
        Dim dt As New Schedules3.car_rate_rule_schedule_detail_3DataTable
    ...
    Private Sub DoUpdate()
        ...
        Dim qa As New Schedules3TableAdapters.QueriesTableAdapter
        ...
        'Dim da2 As New Schedules3TableAdapters.car_rate_rule_schedule_detail_3TableAdapter
        'Dim dt2 As New Schedules3.car_rate_rule_schedule_detail_3DataTable
        ...
        qa.car_rate_rule_schedule_detail_3_delete(scheduleID, sLocation, iMonth)
        ...
        For Each gvr In grdCarTypes.Rows
            ...
            If min.Text.Length > 0 And max.Text.Length > 0 Then
                lblStatus.Text = lblStatus.Text & "<br/>car_rate_rule_schedule_detail_3_insert " & scheduleID & "," & cartype.Text & "," & min.Text & "," & max.Text & "," & iMonth & "," & sLocation

                qa.car_rate_rule_schedule_detail_3_insert(scheduleID, cartype.Text, CDbl(min.Text), CDbl(max.Text), iMonth, sLocation)
            Else
