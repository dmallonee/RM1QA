...
<p>
<p align="center"><font size="5" color="#384F5B">Days Out / Utilization Schedule</font></p>
<p align="center"><font size="2" color="#384F5B">Edit an existing schedule by 
selecting one from the list below</font></p>
<form method="POST" action="rate_rule_schedule_b.asp?type=existing" name="rate_rule_schedule">
...
option below</font></p>
<form method="POST" action="rate_rule_schedule_b.asp?type=new" name="new_rate_rule_schedule">
	...
	<table border="0" width="640" id="new_schedule" bgcolor="#CFD7DB">
		...
		<tr>
			...
			<option selected value="1">Rate Amount Diff.</option>
			<option value="2">Rate Maximum</option>
			<option value="3">Rate Minimum</option>
			</select></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
