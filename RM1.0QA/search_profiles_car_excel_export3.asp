...
'-----------------------------------------------------------------------
	...
	'--- open the template simpletemplate.xls.
		objSAXLTmplt.Open Server.MapPath(Application("vroot") & "templates/profile_extract_template_simple.xls")
	...
	'--- process method.  
		objSAXLTmplt.Process "Rate-Monitor uploadable search profiles for " &  adoRS.Fields("first_name").Value & " " & adoRS.Fields("last_name").Value & ".xls", saProcessOpenInExcel 'saProcessOpenInPlace 'saProcessOpenInExcel
