...
<% Response.Expires = -1
   ...
   'response.write "Error test - 2 <br>"
	...
	If strEditMode <> "1" Then
		...
		adoCmd4.Parameters.Append adoCmd4.CreateParameter("@sandbox",            11, 1, 0, True)
	...
	If intRuleId > 0 Then
		...
		adoCmd5.Parameters.Append adoCmd5.CreateParameter("@user_id",           3, 1, 0, Null)
		adoCmd5.Parameters.Append adoCmd5.CreateParameter("@rate_rule_type_cd", 3, 1, 0, 1)
		adoCmd5.Parameters.Append adoCmd5.CreateParameter("@rule_status",     200, 1, 1, "A")
		adoCmd5.Parameters.Append adoCmd5.CreateParameter("@sandbox",          11, 1, 0, True)
...
<title>Rate-Monitor by Rate-Highway, Inc. | Sandbox Rules | Rate Management</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="100" border="0" cellspacing="0" cellpadding="0" id="table1">
      <tr>
        <td><img alt=""src="images/h_alerts.gif" width="368" height="31"></td>
...
<p class="style4"><strong><br></strong>SANDBOX</p>
<div align="center">
<table cellpadding="0" cellspacing="0" border="0" width="1310" bgcolor="#FFFFFF">
<tr height="1">
<td colspan="1" width="1">&nbsp;</td>
<td rowspan="2" width="169"><img alt=""src="images/ratemanagementalerts2_a.JPG" width="169" height="25" hspace="0" vspace="0" border="0" alt="Rate Management" description=""></td>
<td colspan="1" >&nbsp;</td>
</tr>
<tr height="1">
...
<table border="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="100%" cellspacing="0" height="4">
  ...
  <table width="1108" border="0" cellpadding="2" cellspacing="0" background="images/alt_color.gif" style="border-collapse: collapse" bordercolor="#111111">
    ...
    <% If intCurrentPage<= 1 Then %>
	    ...
	    &lt; 
	<% Else  %>
	    <a href="alerts_rate_management_car_sandbox.asp?user_id=<%=strClientUserid %>&city=<%=strCity%>&car_type=<%=strCarType%>&rule_status=<%=strRuleStatus %>&page=1">|&lt;</a>
	    <a href="alerts_rate_management_car_sandbox.asp?user_id=<%=strClientUserid %>&city=<%=strCity%>&car_type=<%=strCarType%>&rule_status=<%=strRuleStatus %>&page=<%=intCurrentPage - 1%>">&lt;</a> 
    <% End If %>
    ...
    <% Else %>
	    <a href="alerts_rate_management_car_sandbox.asp?user_id=<%=strClientUserid %>&city=<%=strCity%>&car_type=<%=strCarType%>&rule_status=<%=strRuleStatus %>&page=<%=intCurrentPage + 1%>">&gt;</a>
	    <a href="alerts_rate_management_car_sandbox.asp?user_id=<%=strClientUserid %>&city=<%=strCity%>&car_type=<%=strCarType%>&rule_status=<%=strRuleStatus %>&page=<%=intPageCount %>">&gt;|</a>
    <% End If %>
  ...
  <tr>
    ...
    <a target="_self" title="<%=adoRS4.Fields("alert_desc").Value %>" href="alerts_rate_management_car_sandbox.asp?rateruleid=<%=adoRS4.Fields("rate_rule_id").Value %>#rule_maint">
  ...
  <a href="javascript:maint_action(5)">Move to Live system</a> | 
  ...
  |	<a target="_self" href="alerts_rate_management_car_grid.asp">New Grid (leaving sandbox)</a> </form>
...
<form name="create_alert" method="POST" action="" OnSubmit="return CreateAlert()"  >
  ...
  <table border="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="1210" id="new_alert" background="images/alt_color.gif" height="561">
    ...
    <tr>
      ...
      <td width="217" height="25">
      &nbsp;</td>
      <td width="210" height="25">2. Description:</td>      <td width="510" height="25" colspan="8">
    ...
    <tr>
      ...
      <td width="217" height="25">
      &nbsp;</td>
      <td width="210" height="25">3. Rule Begin Date:</td>      <td width="510" height="25" colspan="8">
    ...
    <tr>
      ...
      <td width="217" height="25">
      &nbsp;</td>
      <td width="210" height="25">4. Rule End Date:</td>      <td width="510" height="25" colspan="8">
    ...
    <tr>
      ...
      Pick-up:</td>      <td width="510" height="25" colspan="8">
    ...
    <tr>
      ...
      <td width="217" height="25">
      &nbsp;</td>
      <td width="210" height="25">6. Last Pick-up:</td>      <td width="510" height="25" colspan="8">
    ...
    <tr>
      ...
      Code:</td>      <td width="510" height="25" colspan="8">
    ...
    <tr>
      ...
      Companies:</td>      <td width="510" height="25" colspan="8">&nbsp;</td>
      <td width="262" height="25">&nbsp;</td>
    </tr>
    <tr>
      <td width="8" height="25">&nbsp;</td>
      ...
      &nbsp;&nbsp;&nbsp;Competitive Set:</td>      <td width="256" height="25" colspan="4">
...
&nbsp;&nbsp; (usually self):</td>      <td width="256" height="25" colspan="4">
...
<td width="125" height="25" colspan="2" bgcolor="#FFFFFF" bordercolor="#555566" bordercolorlight="#999999" bordercolordark="#777777" style="border: 1px solid #40618F; padding: 2px">
    ...
    <tr>
      ...
      &nbsp;</td>
      <td width="210" height="25" valign="top" style="padding-top: 2px">
      9. LOR(s):</td>      <td width="510" height="25" colspan="8">
    ...
    <tr>
      ...
      10. Location(s):</td>      <td width="510" height="71" valign="top" colspan="8">
      <select size="4" name="city_cd" style="width:200; font-family:Verdana; font-size:10pt" multiple >
     	 <% intLoopCount = 0                                     %>
         <% While (adoRS6.EOF = False) And (intLoopCount < 200)  %>
    ...
    <tr>
      ...
      11. Car Types:</td>      <td width="510" height="25" colspan="8">
      &nbsp;</td>
      <td width="262" height="25">&nbsp;</td>
    </tr>
    <tr>
      ...
      &nbsp;</td>
      <td width="210" height="25" style="padding-top: 2px">
      &nbsp;&nbsp;&nbsp;&nbsp; Competitive Car Type(s):</td>      <td width="510" height="25" colspan="8">
    ...
    <tr>
      ...
      <td width="210" height="19">&nbsp;&nbsp;&nbsp;&nbsp; 
		Suggestion Car&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp; Type(s):</td>      <td width="510" height="19" colspan="8">
...
&nbsp;both items to have the system match car types)</td>      <td width="262" height="19">&nbsp;</td>
    ...
    <tr>
      ...
      <td width="210" height="22">13. Situation:</td>      <td width="510" height="22" colspan="8">
    ...
    <tr>
      ...
      by amount:<br>
&nbsp;&nbsp;&nbsp; <br>
      </td>      <td width="510" height="23" colspan="8">
...
<font color="#FF0000" face="Courier New" size="2">
    ...
    <tr>
      ...
      Period:</td>      <td width="510" height="22" colspan="8">
    ...
    <tr>
      ...
      No. of Events:</td>      <td width="510" height="22" colspan="8">
    ...
    <tr>
      ...
      <td width="217" height="22">&nbsp;</td>
      <td width="210" height="22">&nbsp;&nbsp;&nbsp; 
      That happen in:</td>      <td width="510" height="22" colspan="8">
    ...
    <tr>
      <td width="8" height="22">&nbsp;</td>
      <td width="217" height="22">&nbsp;</td>
      <td width="210" height="22">15. Response:</td>      <td width="510" height="22" colspan="8">
 ...
 -->
    ...
    <tr>
      ...
      <br>&nbsp;</td>      <td width="510" height="19" colspan="8">
...
-->      
    ...
    <tr>
      ...
      &nbsp;&nbsp;&nbsp; Max. / Min. Schedule</td>      <td width="510" height="22" colspan="8">
		...
		<a title="Click to edit or create a rule schedule" href="rate_rule_maxmin_schedule_a.asp" onclick="window.open('rate_rule_maxmin_schedule_a.asp','manage_schedule','toolbar=no,status=no,scrollbars=yes,resizable=no,width=820,height=600'); return false;">Manage schedules</a></td>      <td width="262" height="22">&nbsp;</td>
    </tr>
    <tr>
      <td width="8" height="22">&nbsp;</td>
      <td width="217" height="22">&nbsp;</td>
    ...
    <tr>
      ...
      <font color="#FF0000" face="Courier New" size="2">
      (beta)</font></td>      <td width="262" height="61">&nbsp;</td>
    </tr>
    <tr>
      <td width="8"  height="19">&nbsp;</td>
      <td width="217" height="19">&nbsp;</td>
...
<p>&nbsp;&nbsp;[<a target="_self" href="alerts_rate_management_car.asp">Live Rules</a>]&nbsp;[<a target="_self" href="rezcentral_tethering_20130715.asp">RezCentral tethering settings</a>]</p>
