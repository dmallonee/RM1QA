...
Partial Class threshold_maxmin_schedule_b
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            linkBack.NavigateUrl = "~/threshold_maxmin_schedule_a.aspx?user_id=" & Request.QueryString("user_id")
        End If
    End Sub
    ...
    Private Sub DoUpdate()
        ...
        'Dim da2 As New SchedulesTableAdapters.car_rate_rule_schedule_detail_6TableAdapter
        'Dim dt2 As New Schedules.car_rate_rule_schedule_detail_6DataTable
        ...
        For Each gvr In grdCarTypes.Rows
            ...
            If min.Text.Length > 0 And max.Text.Length > 0 Then
                lblStatus.Text = lblStatus.Text & "<br/>car_rate_rule_schedule_detail_6_insert " & scheduleID & "," & cartype.Text & "," & min.Text & "," & max.Text & "," & iMonth & "," & sLocation
