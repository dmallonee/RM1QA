...
Partial Class tp_maxmin_schedule_a
    ...
    Private Sub BindSchedules()
        ddlSchedules.DataSource = BLL.car_rate_rule_schedule_header.GetList(Nothing, 3, Request.QueryString("user_id"))
    ...
    Protected Sub btnEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        Response.Redirect(String.Format("tp_maxmin_schedule_b.aspx?schedule_id={0}&user_id={1}&schedule_name={2}", ddlSchedules.SelectedValue, Request.QueryString("user_id"), ddlSchedules.SelectedItem.Text))
    End Sub
    ...
    Protected Sub btnNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        Dim schedule_id As Integer = BLL.car_rate_rule_schedule_header.Save(Nothing, txtNewName.Text, org_id, 3)
