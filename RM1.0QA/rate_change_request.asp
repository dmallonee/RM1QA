...
<p><font size="-1">
 <table width="1300" border="0" cellpadding="2" background="images/alt_color.gif" style="border-collapse: collapse" bordercolor="#111111" id="table1">
    <tr valign="bottom">
      <td >&nbsp;Rate Change Report - Please Review and Confirm</td>
    </tr>
  </table>
  ...
  <table width="1300" border="0" cellpadding="2" background="images/alt_color.gif" style="border-collapse: collapse" bordercolor="#111111">
  <tr valign="bottom">
    <td ><font size="2">| <a href="#bottom_of_grid">Bottom of Grid</a></font> |
    </td>
    </tr>
   </table>
     <table border="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="1300" height="4" id="table2">
 ...
 <%
	    ...
	    <input type="hidden" name="new_rate_amt" >
