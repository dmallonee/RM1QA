  ...
  <tr>
    ...
    <table width="400" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td>
        <a href="alerts_maint_new2.asp" onMouseOver="MM_swapImage('al','','images/b_alert_on.gif',1)" onMouseOut="MM_swapImgRestore()">
...
<form method="POST" action="searched_alerts.asp" name="search_alerts" class="search">
  ...
  <table border="1" style="border-collapse: collapse" bordercolor="#FFFFFF" width="1110" id="profiles">
    <tr>
      ...
      <td class="profile_header" width="48" style="background-color: #E07D1A" height="45">
      <font size="2">Selected</font></td>
      <td class="profile_header" width="72" height="45"><font size="2">Owner</font></td>
      <td class="profile_header" width="295" height="45"><font size="2">Situation</font></td>
      <td class="profile_header" width="181" height="45"><font size="2">Quantity &amp; Period</font></td>
      <td class="profile_header" width="69" height="45"><font size="2">Type</font></td>
      <td class="profile_header" width="72" height="45"><font size="2">Locations</font></td>
      <td class="profile_header" width="174" height="45"><font size="2">
      Recipient or Response</font></td>
      <td class="profile_header" width="200" height="45"><font size="2">Search Type / Profile</font></td>
    </tr>
    <tr>
      <td width="26" class="profile_light" height="20"><font size="2">230e</font></td>
      <td width="48" bgcolor="#FDC677" align="center" height="20">
      <font size="1">
      <input type="radio" value="V1" name="selected" class="nothing"></font></td>
      <td width="72" class="profile_light" height="20"><font size="2">julies</font></td>
      <td width="295" class="profile_light" height="20"><font size="2">Thrifty 
      Any &lt;&gt; Payless + (2.00) Any</font></td>
      <td width="181" class="profile_light" height="20"><font size="2">After 1 
      event</font></td>
      <td width="69" class="profile_light" height="20"><font size="2">Rate</font></td>
      <td width="72" class="profile_light" height="20"><font size="2">Any</font></td>
      <td width="174" class="profile_light" height="20"><font size="2">
      Competitor - $2.00</font></td>
      <td width="200" class="profile_light" height="20"><font size="2">Payless 
      LAX - day</font></td>
    </tr>
    <tr>
      <td width="26" class="profile_light" height="20"><font size="2">231e</font></td>
      <td width="48" bgcolor="#FDC677" align="center" height="20">
      <font size="1">
      <input type="radio" value="V1" name="selected1" class="nothing" checked></font></td>
      <td width="72" class="profile_light" height="20"><font size="2">julies</font></td>
      <td width="295" class="profile_light" height="20"><font size="2">Thrifty 
      Any &lt;&gt; Payless + (1.00) Any</font></td>
      <td width="181" class="profile_light" height="20"><font size="2">After 1 
      event</font></td>
      <td width="69" class="profile_light" height="20"><font size="2">Rate</font></td>
      <td width="72" class="profile_light" height="20"><font size="2">Any</font></td>
      <td width="174" class="profile_light" height="20"><font size="2">
      Competitor - $1.00</font></td>
      <td width="200" class="profile_light" height="20"><font size="2">Payless 
      LAX - wknd</font></td>
    </tr>
    <tr>
      <td width="26" class="profile_light" height="20"><font size="2">232e</font></td>
      <td width="48" bgcolor="#FDC677" align="center" height="20">
      <font size="1">
      <input type="radio" value="V1" name="selected2" class="nothing" checked></font></td>
      <td width="72" class="profile_light" height="20"><font size="2">julies</font></td>
      <td width="295" class="profile_light" height="20"><font size="2">Thrifty 
      Any &lt;&gt; Payless + (7.00) Any</font></td>
      <td width="181" class="profile_light" height="20"><font size="2">After 1 
      event</font></td>
      <td width="69" class="profile_light" height="20"><font size="2">Rate</font></td>
      <td width="72" class="profile_light" height="20"><font size="2">Any</font></td>
      <td width="174" class="profile_light" height="20"><font size="2">
      Competitor - $7.00</font></td>
      <td width="200" class="profile_light" height="20"><font size="2">Payless 
      LAX - wkly</font></td>
    </tr>
    </table>
...
<form name="create_alert" method="POST" action="alerts_maint_new2.asp" OnSubmit="CreateAlert();return false">
  <table border="0" style="border-collapse: collapse" bordercolor="#FFFFFF" width="1110" cellspacing="0" height="4">
    <tr>
      <td background="images/ruler.gif"></td>
      <td background="images/ruler.gif"></td>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="1110" id="new_alert" background="images/alt_color.gif" height="561">
    ...
    <tr>
      ...
      <input type="text" name="rate_alert_number" size="20" style="width:200; font-family:Verdana; font-size:10pt; text-align:right; background-image:url('images/alt_color.gif')" value="233" READONLY></td>
    ...
    <tr>
      ...
      Pick-up:</font></td>
      <td width="672" height="25">
                <input type="text" name="pick_up_datetime" class="fsmall" style="width:200"  size='20' maxlength="10" onFocus="javascript:vDateType='1'" onKeyUp="DateFormat(this,this.value,event,false,'1')" onBlur="DateFormat(this,this.value,event,true,'1')" value="continuous">
                <a href="javascript:cal6.popup();">
                <img src="images/cal.gif" width="16" height="16" border="0" alt="Click here to select the start date"></a></td>
      <td width="169" height="25">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td width="672" height="25">
                <input type="text" name="drop_off_datetime" class="fsmall" style="width:200"  size='20' maxlength="10" onFocus="javascript:vDateType='1'" onKeyUp="DateFormat(this,this.value,event,false,'1')" onBlur="DateFormat(this,this.value,event,true,'1')" value="continuous">
                <a href="javascript:cal6.popup();">
                <img src="images/cal.gif" width="16" height="16" border="0" alt="Click here to select the start date"></a></td>
      <td width="169" height="25">&nbsp;</td>
    </tr>
...
<option value="BUDGET">BUDGET </option>
<option value="DOLLAR">DOLLAR </option>
<option value="ENTERPRISE">ENTERPRISE </optitypeon        t>
<option value="FOX">FOX </option>
<option value="HERTZ">HERTZ </option>
<option value="NATIONAL">NATIONAL </option>
<option value="THRIFTY">THRIFTY </option>
...
&nbsp;both items to have the system to match car types)</font></td>
    ...
    <tr>
      ...
      <option><> (any competitor) - diff</option>
      <option><> (all competitors) - diff</option>
      <option><> (any competitor) + diff</option>
      <option><> (all competitors) + diff</option>
      </select></td>
    ...
    <tr>
      ...
      <br>
      <input type="radio" value="dollar" name="amount_type1" style="font-family:Verdana; font-size:10pt"><font face="Verdana" size="2">Whole Dollar<br>
      <input type="radio" value="percent" name="amount_type1" style="font-family:Verdana; font-size:10pt"><font face="Verdana" size="2">Percentage</td>
    ...
    <tr>
      ...
      <td width="672" height="22">
      <input type="text" name="period_events" size="20" style="width:200; font-family:Verdana; font-size:10pt; text-align:right"></td>
      <td width="169" height="22">&nbsp;</td>
    </tr>
    <tr>
      <td width="11" height="22">&nbsp;</td>
      ...
      No. of:</font></td>
      <td width="672" height="22">
      <input type="text" name="period_hours" size="20" style="width:137; font-family:Verdana; font-size:10pt; text-align:right; height:22">
    ...
    <tr>
      <td width="11" height="22">&nbsp;</td>
      <td width="247" height="22">&nbsp;</td>
      <td width="200" height="22"><font face="Verdana" size="2">15. Recipient</font>:</td>
      <td width="672" height="22">
